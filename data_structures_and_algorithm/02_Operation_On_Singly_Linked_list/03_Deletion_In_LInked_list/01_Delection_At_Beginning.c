...
// function for deleting the first node of the linked list
struct Node * Delection_At_Beginning(struct Node * head){
...
int main(){
    ...
    // traversal the linked list befort the delection the first node of the linked list
    Traversal_List(head);

    head = Delection_At_Beginning(head);

    // traversal the linked list after the delection the first node of the linked list
    Traversal_List(head);
